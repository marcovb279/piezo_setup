...
#define IFM_OPTION_BOOTLOADER     0x0004
#define IFM_OPTION_BEAMBREAK      0x0005
...
#define IFM_DEVINFO_OUTRATE_POINTER    14   // Ponter to a double value, containing the OWR in higher resolution
...
#define IFM_DEVINFO_SRATE_POINTER      21   // pointer to the current sample rate
